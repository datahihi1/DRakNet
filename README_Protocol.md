...
| Name                           | ID   | Type    |Mark|
| ------------------------------ | ---- | ------- |----|
| UnconnectedPing                | 0x01 | OFFLINE |ok  |
| UnconnectedPingOpenConnections | 0x02 | OFFLINE |id  |
| UnconnectedPong                | 0x1c | OFFLINE |ok  |
| ConnectedPing                  | 0x00 | ONLINE  |id  |
| ConnectedPong                  | 0x03 | ONLINE  |id  |
| OpenConnectionRequest1         | 0x05 | OFFLINE |ok  |
| OpenConnectionReply1           | 0x06 | OFFLINE |ok  |
| OpenConnectionRequest2         | 0x07 | OFFLINE |ok  |
| OpenConnectionReply2           | 0x08 | OFFLINE |ok  |
| ConnectionRequest              | 0x09 | ONLINE  |id  |
| RemoteSystemRequiresPublicKey  | 0x0a | ONLINE  |id  |
| OurSystemRequiresSecurity      | 0x0b | OFFLINE |id  |
| ConnectionAttemptFailed        | 0x11 | BOTH    |id  |
| AlreadyConnected               | 0x12 | OFFLINE |id  |
| ConnectionRequestAccepted      | 0x10 | ONLINE  |id  |
| NewIncomingConnection          | 0x13 | ONLINE  |id  |
| NoFreeIncomingConnections      | 0x14 | OFFLINE |id  |
| DisconnectionNotification      | 0x15 | BOTH    |id  |
| ConnectionLost                 | 0x16 | BOTH    |id  |
| IncompatibleProtocolVersion    | 0x19 | OFFLINE |ok  |
